...
setmetatable(logic_meta, ENTITY) -- Lower base of logic entities is Entity
...
function ENT:SetLogicTable(tbl) -- For entity-tied 
	self.LOGIC_TABLE = {
		Entity = self,
	}
	
	setmetatable(self.LOGIC_TABLE, tbl)
	self.LOGIC_TYPE = nil
	
	duplicator.StoreEntityModifier(self, "nzu_logic_type", nil)
