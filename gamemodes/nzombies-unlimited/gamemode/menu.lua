...
if CLIENT then
	...
	function PLAYER_LINE:Init()
		...
		self.Avatar = self:Add("nzu_PlayerAvatar")
	...
	function PLAYER_LINE:Setup(ply)
		self.Player = ply
		if IsValid(self.Avatar) then self.Avatar:SetPlayer(ply) end
	...
	vgui.Register("nzu_MenuPanel_PlayerLine", PLAYER_LINE, "DPanel")
